...
public class BSTree<T extends Comparable<? super T>> {
  ...
  private int countBetween(T a, T b, BSTNode<T> n) {
    if (n == null) return 0;
    if (n.getValue().compareTo(a) < 0) return 0 + countBetween(a, b, n.getRight());
    if (n.getValue().compareTo(b) > 0) return 0 + countBetween(a, b, n.getLeft());
